---
type: "BigQuery View"
title: "ultracart_dw_low.uc_affiliates"
description: "Affiliate dimension and affiliate account metadata."
resource: "urn:ultracart:bigquery:object:ultracart_dw_low.uc_affiliates"
tags:
  - "ultracart"
  - "bigquery"
  - "view"
...
# ultracart_dw_low.uc_affiliates
...
FROM `{{ source_project }}.ultracart_dw_low.uc_affiliates`;
```
