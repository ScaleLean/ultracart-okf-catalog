---
type: "BigQuery View"
title: "ultracart_dw_low.uc_fraud_rules"
description: "Fraud rule configuration."
resource: "urn:ultracart:bigquery:object:ultracart_dw_low.uc_fraud_rules"
tags:
  - "ultracart"
  - "bigquery"
  - "view"
...
# ultracart_dw_low.uc_fraud_rules
...
FROM `{{ source_project }}.ultracart_dw_low.uc_fraud_rules`;
```
