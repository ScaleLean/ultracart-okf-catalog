---
type: "BigQuery View"
title: "ultracart_dw_low.uc_rotating_transaction_gateway_history"
description: "Rotating transaction gateway history and events."
resource: "urn:ultracart:bigquery:object:ultracart_dw_low.uc_rotating_transaction_gateway_history"
tags:
  - "ultracart"
  - "bigquery"
  - "view"
...
# ultracart_dw_low.uc_rotating_transaction_gateway_history
...
FROM `{{ source_project }}.ultracart_dw_low.uc_rotating_transaction_gateway_history`;
```
