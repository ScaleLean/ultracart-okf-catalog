---
type: "BigQuery View"
title: "ultracart_dw_low.uc_affiliate_clicks"
description: "Affiliate click and source data."
resource: "urn:ultracart:bigquery:object:ultracart_dw_low.uc_affiliate_clicks"
tags:
  - "ultracart"
  - "bigquery"
  - "view"
...
# ultracart_dw_low.uc_affiliate_clicks
...
FROM `{{ source_project }}.ultracart_dw_low.uc_affiliate_clicks`;
```
