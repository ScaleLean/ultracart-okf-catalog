---
type: "BigQuery View"
title: "ultracart_dw_low.uc_towerdata_email_intelligence"
description: "Customer enrichment and email intelligence surface. Treat as optional and sensitive."
resource: "urn:ultracart:bigquery:object:ultracart_dw_low.uc_towerdata_email_intelligence"
tags:
  - "ultracart"
  - "bigquery"
  - "view"
...
# ultracart_dw_low.uc_towerdata_email_intelligence
...
FROM `{{ source_project }}.ultracart_dw_low.uc_towerdata_email_intelligence`;
```
