---
type: "BigQuery View"
title: "ultracart_dw_high.uc_storefront_traffic_logs"
description: "Storefront traffic log feed. Constrain by time and storefront when querying."
resource: "urn:ultracart:bigquery:object:ultracart_dw_high.uc_storefront_traffic_logs"
tags:
  - "ultracart"
  - "bigquery"
  - "view"
...
# ultracart_dw_high.uc_storefront_traffic_logs
...
FROM `{{ source_project }}.ultracart_dw_high.uc_storefront_traffic_logs`;
```
