---
type: "BigQuery View"
title: "ultracart_dw_high.uc_storefront_upsell_paths"
description: "Upsell path configuration."
resource: "urn:ultracart:bigquery:object:ultracart_dw_high.uc_storefront_upsell_paths"
tags:
  - "ultracart"
  - "bigquery"
  - "view"
...
# ultracart_dw_high.uc_storefront_upsell_paths
...
FROM `{{ source_project }}.ultracart_dw_high.uc_storefront_upsell_paths`;
```
