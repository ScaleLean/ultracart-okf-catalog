---
type: "BigQuery View"
title: "ultracart_dw.uc_affiliate_payments"
description: "Affiliate payment records for aggregate payment reporting."
resource: "urn:ultracart:bigquery:object:ultracart_dw.uc_affiliate_payments"
tags:
  - "ultracart"
  - "bigquery"
  - "view"
...
# ultracart_dw.uc_affiliate_payments
...
FROM `{{ source_project }}.ultracart_dw.uc_affiliate_payments`;
```
