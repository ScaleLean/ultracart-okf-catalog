---
type: "BigQuery View"
title: "ultracart_dw.uc_affiliates"
description: "Affiliate dimension and affiliate account metadata."
resource: "urn:ultracart:bigquery:object:ultracart_dw.uc_affiliates"
tags:
  - "ultracart"
  - "bigquery"
  - "view"
...
FROM `{{ source_project }}.ultracart_dw.uc_affiliates`;
```
