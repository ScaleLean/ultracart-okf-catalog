---
type: "BigQuery View"
title: "ultracart_dw.uc_storefront_customer_emails"
description: "Storefront email membership and status data."
resource: "urn:ultracart:bigquery:object:ultracart_dw.uc_storefront_customer_emails"
tags:
  - "ultracart"
  - "bigquery"
  - "view"
...
# ultracart_dw.uc_storefront_customer_emails
...
FROM `{{ source_project }}.ultracart_dw.uc_storefront_customer_emails`;
```
