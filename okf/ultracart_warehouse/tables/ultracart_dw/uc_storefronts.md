---
type: "BigQuery View"
title: "ultracart_dw.uc_storefronts"
description: "Host and storefront dimension."
resource: "urn:ultracart:bigquery:object:ultracart_dw.uc_storefronts"
tags:
  - "ultracart"
  - "bigquery"
  - "view"
...
FROM `{{ source_project }}.ultracart_dw.uc_storefronts`;
```
