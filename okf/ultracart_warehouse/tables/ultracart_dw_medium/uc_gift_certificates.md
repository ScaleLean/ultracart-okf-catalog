---
type: "BigQuery View"
title: "ultracart_dw_medium.uc_gift_certificates"
description: "Gift certificate records for operational reporting."
resource: "urn:ultracart:bigquery:object:ultracart_dw_medium.uc_gift_certificates"
tags:
  - "ultracart"
  - "bigquery"
  - "view"
...
# ultracart_dw_medium.uc_gift_certificates
...
FROM `{{ source_project }}.ultracart_dw_medium.uc_gift_certificates`;
```
