---
type: "BigQuery View"
title: "ultracart_dw_medium.uc_workflow_tasks"
description: "Workflow task mirror for analytics and operational review."
resource: "urn:ultracart:bigquery:object:ultracart_dw_medium.uc_workflow_tasks"
tags:
  - "ultracart"
  - "bigquery"
  - "view"
...
# ultracart_dw_medium.uc_workflow_tasks
...
FROM `{{ source_project }}.ultracart_dw_medium.uc_workflow_tasks`;
```
