---
type: "BigQuery View"
title: "ultracart_dw_medium.uc_integration_logs"
description: "Integration event log with raw content redacted in standard views."
resource: "urn:ultracart:bigquery:object:ultracart_dw_medium.uc_integration_logs"
tags:
  - "ultracart"
  - "bigquery"
  - "view"
...
# ultracart_dw_medium.uc_integration_logs
...
FROM `{{ source_project }}.ultracart_dw_medium.uc_integration_logs`;
```
