---
type: "BigQuery View"
title: "ultracart_dw_medium.uc_storefronts"
description: "Host and storefront dimension."
resource: "urn:ultracart:bigquery:object:ultracart_dw_medium.uc_storefronts"
tags:
  - "ultracart"
  - "bigquery"
  - "view"
...
# ultracart_dw_medium.uc_storefronts
...
FROM `{{ source_project }}.ultracart_dw_medium.uc_storefronts`;
```
