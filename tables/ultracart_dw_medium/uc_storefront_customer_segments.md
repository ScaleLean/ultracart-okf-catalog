---
type: "BigQuery View"
title: "ultracart_dw_medium.uc_storefront_customer_segments"
description: "Storefront customer segment membership data."
resource: "urn:ultracart:bigquery:object:ultracart_dw_medium.uc_storefront_customer_segments"
tags:
  - "ultracart"
  - "bigquery"
  - "view"
...
# ultracart_dw_medium.uc_storefront_customer_segments
...
FROM `{{ source_project }}.ultracart_dw_medium.uc_storefront_customer_segments`;
```
