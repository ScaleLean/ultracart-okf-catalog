---
type: "BigQuery View"
title: "ultracart_dw_medium.uc_coupons"
description: "Coupon configuration and discount rules."
resource: "urn:ultracart:bigquery:object:ultracart_dw_medium.uc_coupons"
tags:
  - "ultracart"
  - "bigquery"
  - "view"
...
# ultracart_dw_medium.uc_coupons
...
FROM `{{ source_project }}.ultracart_dw_medium.uc_coupons`;
```
