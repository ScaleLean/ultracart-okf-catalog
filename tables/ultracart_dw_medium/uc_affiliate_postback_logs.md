---
type: "BigQuery View"
title: "ultracart_dw_medium.uc_affiliate_postback_logs"
description: "Affiliate postback event log."
resource: "urn:ultracart:bigquery:object:ultracart_dw_medium.uc_affiliate_postback_logs"
tags:
  - "ultracart"
  - "bigquery"
  - "view"
...
# ultracart_dw_medium.uc_affiliate_postback_logs
...
FROM `{{ source_project }}.ultracart_dw_medium.uc_affiliate_postback_logs`;
```
