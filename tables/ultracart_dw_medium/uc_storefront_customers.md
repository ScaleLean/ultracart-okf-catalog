---
type: "BigQuery View"
title: "ultracart_dw_medium.uc_storefront_customers"
description: "Storefront customer profile and listing surface."
resource: "urn:ultracart:bigquery:object:ultracart_dw_medium.uc_storefront_customers"
tags:
  - "ultracart"
  - "bigquery"
  - "view"
...
# ultracart_dw_medium.uc_storefront_customers
...
FROM `{{ source_project }}.ultracart_dw_medium.uc_storefront_customers`;
```
