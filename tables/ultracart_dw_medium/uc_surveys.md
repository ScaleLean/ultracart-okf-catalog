---
type: "BigQuery View"
title: "ultracart_dw_medium.uc_surveys"
description: "Survey definitions and response structures depending on nested fields."
resource: "urn:ultracart:bigquery:object:ultracart_dw_medium.uc_surveys"
tags:
  - "ultracart"
  - "bigquery"
  - "view"
...
# ultracart_dw_medium.uc_surveys
...
FROM `{{ source_project }}.ultracart_dw_medium.uc_surveys`;
```
