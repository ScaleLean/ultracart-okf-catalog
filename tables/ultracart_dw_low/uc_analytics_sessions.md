---
type: "BigQuery View"
title: "ultracart_dw_low.uc_analytics_sessions"
description: "UltraCart analytics session model with nested hits and session behavior fields."
resource: "urn:ultracart:bigquery:object:ultracart_dw_low.uc_analytics_sessions"
tags:
  - "ultracart"
  - "bigquery"
  - "view"
...
# ultracart_dw_low.uc_analytics_sessions
...
FROM `{{ source_project }}.ultracart_dw_low.uc_analytics_sessions`;
```
