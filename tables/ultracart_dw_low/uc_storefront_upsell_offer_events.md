---
type: "BigQuery View"
title: "ultracart_dw_low.uc_storefront_upsell_offer_events"
description: "Upsell event log."
resource: "urn:ultracart:bigquery:object:ultracart_dw_low.uc_storefront_upsell_offer_events"
tags:
  - "ultracart"
  - "bigquery"
  - "view"
...
# ultracart_dw_low.uc_storefront_upsell_offer_events
...
FROM `{{ source_project }}.ultracart_dw_low.uc_storefront_upsell_offer_events`;
```
