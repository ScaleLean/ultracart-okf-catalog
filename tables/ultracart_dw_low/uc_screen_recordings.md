---
type: "BigQuery View"
title: "ultracart_dw_low.uc_screen_recordings"
...
resource: "urn:ultracart:bigquery:object:ultracart_dw_low.uc_screen_recordings"
tags:
  - "ultracart"
  - "bigquery"
  - "view"
...
# ultracart_dw_low.uc_screen_recordings
...
FROM `{{ source_project }}.ultracart_dw_low.uc_screen_recordings`;
```
