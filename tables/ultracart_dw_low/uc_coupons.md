---
type: "BigQuery View"
title: "ultracart_dw_low.uc_coupons"
description: "Coupon configuration and discount rules."
resource: "urn:ultracart:bigquery:object:ultracart_dw_low.uc_coupons"
tags:
  - "ultracart"
  - "bigquery"
  - "view"
...
FROM `{{ source_project }}.ultracart_dw_low.uc_coupons`;
```
