---
type: "BigQuery View"
title: "ultracart_dw_high.uc_affiliate_network_pixels"
description: "Affiliate and network pixel configuration."
resource: "urn:ultracart:bigquery:object:ultracart_dw_high.uc_affiliate_network_pixels"
tags:
  - "ultracart"
  - "bigquery"
  - "view"
...
# ultracart_dw_high.uc_affiliate_network_pixels
...
FROM `{{ source_project }}.ultracart_dw_high.uc_affiliate_network_pixels`;
```
