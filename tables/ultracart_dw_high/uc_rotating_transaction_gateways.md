---
type: "BigQuery View"
title: "ultracart_dw_high.uc_rotating_transaction_gateways"
description: "Rotating transaction gateway configuration."
resource: "urn:ultracart:bigquery:object:ultracart_dw_high.uc_rotating_transaction_gateways"
tags:
  - "ultracart"
  - "bigquery"
  - "view"
...
# ultracart_dw_high.uc_rotating_transaction_gateways
...
FROM `{{ source_project }}.ultracart_dw_high.uc_rotating_transaction_gateways`;
```
