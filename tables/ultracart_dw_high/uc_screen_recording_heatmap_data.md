---
type: "BigQuery View"
title: "ultracart_dw_high.uc_screen_recording_heatmap_data"
description: "Heatmap and click-position support data for session behavior analysis."
resource: "urn:ultracart:bigquery:object:ultracart_dw_high.uc_screen_recording_heatmap_data"
tags:
  - "ultracart"
  - "bigquery"
  - "view"
...
# ultracart_dw_high.uc_screen_recording_heatmap_data
...
FROM `{{ source_project }}.ultracart_dw_high.uc_screen_recording_heatmap_data`;
```
