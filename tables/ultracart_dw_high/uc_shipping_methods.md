---
type: "BigQuery View"
title: "ultracart_dw_high.uc_shipping_methods"
description: "Shipping method configuration."
resource: "urn:ultracart:bigquery:object:ultracart_dw_high.uc_shipping_methods"
tags:
  - "ultracart"
  - "bigquery"
  - "view"
...
# ultracart_dw_high.uc_shipping_methods
...
FROM `{{ source_project }}.ultracart_dw_high.uc_shipping_methods`;
```
