---
type: "BigQuery View"
title: "ultracart_dw.uc_fraud_rules"
description: "Fraud rule configuration."
resource: "urn:ultracart:bigquery:object:ultracart_dw.uc_fraud_rules"
tags:
  - "ultracart"
  - "bigquery"
  - "view"
...
FROM `{{ source_project }}.ultracart_dw.uc_fraud_rules`;
```
