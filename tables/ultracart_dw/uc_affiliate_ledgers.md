---
type: "BigQuery View"
title: "ultracart_dw.uc_affiliate_ledgers"
description: "Affiliate commission and transaction ledger with order linkage."
resource: "urn:ultracart:bigquery:object:ultracart_dw.uc_affiliate_ledgers"
tags:
  - "ultracart"
  - "bigquery"
  - "view"
...
# ultracart_dw.uc_affiliate_ledgers
...
FROM `{{ source_project }}.ultracart_dw.uc_affiliate_ledgers`;
```
